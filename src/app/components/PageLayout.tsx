...
export default function PageLayout({ title, children }: { title: string; children: ReactNode }) {
  return (
    <main className="relative overflow-hidden bg-dusk flex items-center justify-center min-h-screen px-4 md:px-8 lg:px-16">
      <div className="absolute inset-0 bg-gradient-radial from-accent-purple/20 to-transparent pointer-events-none" />
      <div className="relative z-10 w-full max-w-3xl flex flex-col items-center space-y-8 md:space-y-12 py-16">
